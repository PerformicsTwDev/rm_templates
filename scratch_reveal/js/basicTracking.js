var Performics = {};
Performics.settings = {
  Lp_url: "https://www.eyesmart.com.tw/event/895/",
  exit_label: "exit",
  ...
  FLD: {
    ...
    u2: "0",
    u3: "PMP",
    u4: "PMSC000235_Alcon_CNY_20210107",
    u5: "0",
    u6: "0",
    u7: "0",
    u8: "0",
...
(function (settings) {
  ...
  function addDom() {
    ...
    creative.dom.scratchBox = document.getElementById("scratchBox");
  }
  ...
  function addTracking() {
    ...
    creative.dom.scratchBox.addEventListener("touchend",function (){
      Enabler.exitOverride("exit", Lp_url);
      addImpClkFLD(a.DBM_CLK);
    });

    creative.dom.scratchBox.addEventListener("mouseup",function (){
      Enabler.exitOverride("exit", Lp_url);
      addImpClkFLD(a.DBM_CLK);
    });

    creative.dom.scratchBox.addEventListener("mousedown",function (){
      Enabler.exitOverride("exit", Lp_url);
      addImpClkFLD(a.DBM_CLK);
    });
  }
