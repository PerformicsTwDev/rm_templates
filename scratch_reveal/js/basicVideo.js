...
2.videoCss
 */
  var Lp_url = basic_url;
  var videoCssLink = "css/video_320480_contain-up.css"; //Choose the right type of video css
 ...
 */
  ...
  var video_src =
    "https://gcdn.2mdn.net/videoplayback/id/5bb4d145d9d34057/itag/15/source/doubleclick/ratebypass/yes/mime/video%2Fmp4/acao/yes/ip/0.0.0.0/ipbits/0/expire/3755573217/sparams/id,itag,source,ratebypass,mime,acao,ip,ipbits,expire/signature/7C61153EA02CEF456E84182220CEAE59EA5D3498.6AC68922BA577FDC548B89AB5570ECF4004646CC/key/ck2/file/file.mp4";
 ...
 */
  ...
  //basic FLD setting
  var FLD_src = _src || "9523457",
    FLD_type = _type || "invmedia",
    FLD_cat = _cat || "pmp_v0";
  ...
  var u1 = _u1 || "0",
    u2 = _u2 || "0",
    u3 = _u3 || "0",
    u4 = _u4 || "PMSC000235_Alcon_CNY_20210107",
    u5 = _u5 || "0",
    u6 = _u6 || "0",
    u7 = _u7 || "0",
    u8 = _u8 || "0",
 ...
 */
  ...
  //     if(percVal>=50 && !video_ended && !is_clicked){
  //       playVideo22();
  //     }else if (percVal<50 && !video_ended && !is_clicked){
  //       pauseVideo22();
  //     }
  //     },500)
  // }
