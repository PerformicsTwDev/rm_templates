(function (settings) {
  ...
  function addTracking() {
    var a = FLD_res[0];
    // creative.dom.bgExit.addEventListener("click",function(){addImpClkFLD(a.DBM_CLK);});
    // creative.dom.bgExit.addEventListener("touchEnd",function(){addImpClkFLD(a.DBM_CLK);});
