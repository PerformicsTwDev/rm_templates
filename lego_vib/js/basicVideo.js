 ...
 */
  var Lp_url =
    basic_url ||
    "https://ad.doubleclick.net/ddm/trackclk/N1023889.279382DBMPERFORMICSTW-1/B25251252.293031034;dc_trk_aid=486024119;dc_trk_cid=144275142;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;gdpr=${GDPR};gdpr_consent=${GDPR_CONSENT_755}"; //filled to determined the video landing page
  var videoCssLink = "css/video.css"; //Choose the right type of video css
 ...
 */
  ...
  var video_src =
    "https://gcdn.2mdn.net/videoplayback/id/66cc3da53c6af0dc/itag/15/source/doubleclick/ratebypass/yes/mime/video%2Fmp4/acao/yes/ip/0.0.0.0/ipbits/0/expire/3755141746/sparams/id,itag,source,ratebypass,mime,acao,ip,ipbits,expire/signature/16A26CC8515E8F74AA5FE8968774ECC5C80B49B0.B639D2F30B150679A9FD3C07F22906E83174B74/key/ck2/file/file.mp4";
 ...
 */
  ...
  //basic FLD setting
  var FLD_src = _src || "9052290",
    FLD_type = _type || "pmp_c0",
    FLD_cat = _cat || "pc_tt0";
 ...
 */
  ...
  var ADD_VIDEO_LISTENER = function videoListeners() {
    this.counter5s = timer.bind(this, 5, "5S_View");
    ...
    videoM.dom.vid.addEventListener("timeupdate", this.counter5s, false);
  };
  ...
  function timer(sec, label) {
    ...
    if (currentPos > sec) {
      if (is_click == true) {
        Enabler.counter("5S_View");
        videoM.dom.vid.removeEventListener("timeupdate", this.counter5s, false);
        console.log("5s");
      }
    }
  }
